...
(function() {
var __m = ["vs/base/common/marked/marked","vs/editor/common/modes/textToHtmlTokenizer","require","exports","vs/platform/markers/common/markers","vs/base/common/strings","vs/editor/common/modes/nullMode","vs/languages/markdown/common/markdownWorker","vs/base/common/marked/raw.marked","vs/base/common/uri","vs/base/common/types","vs/base/common/paths","vs/base/common/platform","vs/editor/common/services/modeService","vs/editor/common/services/resourceService","vs/base/common/winjs.base"];
...
define(__m[1], __M([2,3,5,6]), function (require, exports, strings, nullMode_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[7], __M([2,3,15,9,10,11,0,1,12,13,14,4]), function (require, exports, WinJS, uri_1, Types, Paths, Marked, textToHtmlTokenizer_1, platform_1, modeService_1, resourceService_1, markers_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
